...
import { loginAdmin, appointmentsAdmin, appointmentCancel, addDoctor, allDoctors, 
    ...
    allUsers, allOperators, doctorProfile,deleteUser } from '../controllers/adminController.js';
...
adminRouter.post("/update-operator-profile", authAdmin, upload.single('image'), updateOperatorProfile)
